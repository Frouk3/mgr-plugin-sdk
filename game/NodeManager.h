...
struct NodeManager
{
    ...
    NodeManager::NodeSystem m_MainNodeSystem;
    NodeManager::NodeSystem field_190[3];
    int field_640;
    int field_644;
    int field_648;
    int field_64C;
    ...
    int field_7C8;
    int field_7CC;
    Hw::cFixedList<NodeInfo *> field_7D0;
    Hw::cFixedList<NodeInfo *> m_InfoNodes;
    Hw::cFixedList<NodeNavigation *> m_Navigations;
    int field_824;
    int field_828;
    int field_82C;
    int field_830;
...
struct waypoint::WaypointNode
{
    NodeManager::NodeSystem::Node *m_Node;
    int field_4;
    int field_8;
    int field_C;
    int field_10;
...
struct NodeNavigation
{
    ...
    int field_808;
    int field_80C;
    NodeManager::NodeSystem *m_ParentSystem;
    int field_814;
    int field_818;
    int field_81C;
    int field_820;
