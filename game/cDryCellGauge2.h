...
public:
    ...
    float field_248;
    float field_24C;
    cEspControler field_250;
    int field_300;
    int field_304;
    int field_308;
    cCustomObjCtrlManager field_30C;
    cCustomObjCtrlManager field_328;
    cCustomObjCtrlManager field_344;
    cCustomObjCtrlManager field_360;
    cCustomObjCtrlManager field_37C;
    float field_398;
    float field_39C;
    float field_3A0;
    int field_3A4;
