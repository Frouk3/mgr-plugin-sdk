...
namespace Hw
{
    ...
    inline void __cdecl MtxLookAt(Hw::cMtx &matrix, const Hw::cVec3& trans, const Hw::cVec3& target, const Hw::cVec3& rot) { ((void(__cdecl*)(Hw::cMtx&, const Hw::cVec3&, const Hw::cVec3&, const Hw::cVec3&))(shared::base + 0x9E01A0))(matrix, trans, target, rot); }
    inline void __cdecl MtxLookAt(Hw::cMtx &matrix, const Hw::cVec4& trans, const Hw::cVec4& target, const Hw::cVec4& rot) { ((void(__cdecl*)(Hw::cMtx&, const Hw::cVec4&, const Hw::cVec4&, const Hw::cVec4&))(shared::base + 0x9E05B0))(matrix, trans, target, rot); }
